...
*/
        ...
        if (num1>num2 && num1>num3) {
           ...
           if (num2 > num3) {
                ...
                System.out.println(num3+" "+num2+" sayilar birbirine esittir");
            }
            ...
            if (num1 > num3) {
                ...
                System.out.println(num1+" "+num3 +" sayilar birbirine esittir");
            }
            ...
            if (num1 > num2) {
                ...
                System.out.println(num1+" "+num2+ " sayilar birbirine esittir");
            }
